...
# --- 7. ደረሰኝ መቀበያ (ከበተኖች ውጭ ያለውን ሁሉ የሚይዝ) ---
@bot.message_handler(content_types=['photo', 'text'])
def handle_receipts(message):
    uid = str(message.chat.id)
    # አድሚኑንና ትዕዛዞችን አያስተናግድም
