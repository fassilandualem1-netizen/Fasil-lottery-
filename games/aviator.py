...
def _get_user_balance(user_id):
    return round(float(redis.hget("users:balance", _get_balance_key(user_id)) or 0.0), 2)
    ...
    def loop():
        while True:
            try:
                ...
                game_state["round_id"] = game_state.get("round_id", 0) + 1
                ...
                with bet_lock:
                    ...
                    current_round_bets.update(next_round_bets)
